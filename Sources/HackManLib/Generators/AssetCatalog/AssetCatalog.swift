...
class AssetCatalog: NSObject, Generator {
    ...
    func generate(arguments: [String], options: [String]) {
        ...
        Writer.createFile("Source/Assets.xcassets/Contents.json", contents: contents, options: options)
        ...
        Writer.createFile("Source/Assets.xcassets/AppIcon.appiconset/Contents.json", contents: contents2, options: options)
